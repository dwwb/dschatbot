...
if __name__ == '__main__':
	...
	scheduler.add_job(boss_scheduler, 'cron', (0, 4), day_of_week="fri", hour=23, minute=10)
	#Кзарка Каранда
	scheduler.add_job(boss_scheduler, 'cron', (0, 1), day_of_week="sun", hour=23, minute=10)
	#Карнда Нубера
	scheduler.add_job(boss_scheduler, 'cron', (1, 4), day_of_week="mon", hour=22, minute=10)
	#Каранда Кутум
#	scheduler.add_job(boss_scheduler, 'cron', (1, 3), day_of_week="sat", hour=23, minute=10)
	#Квинт Мурака
	scheduler.add_job(boss_scheduler, 'cron', (5, 6), day_of_week="sat", hour=13, minute=40)
	scheduler.add_job(boss_scheduler, 'cron', (5, 6), day_of_week="tue", hour=22, minute=10)
	#Офин
	scheduler.add_job(boss_scheduler, 'cron', (2, 8), day_of_week="wed, fri, sun", hour=22, minute=10)
	#Нубер
	...
	scheduler.add_job(boss_scheduler, 'cron', (4, 8), day_of_week="thu", hour=23, minute=10)
	#Кутум
	...
	scheduler.add_job(boss_scheduler, 'cron', (3, 8), day_of_week="tue", hour=23, minute=10)
	#Каранда
	...
	scheduler.add_job(boss_scheduler, 'cron', (1, 8), day_of_week="wed", hour=23, minute=10)
	#Кзарка
	...
	scheduler.add_job(boss_scheduler, 'cron', (0, 8), day_of_week="mon", hour=23, minute=10)
	#Велл
	...
	#Камос
	scheduler.add_job(boss_scheduler, 'cron', (9, 8), day_of_week="thu", hour=22, minute=10)
	scheduler.add_job(boss_scheduler, 'cron', (9, 8), day_of_week="sat", hour=23, minute=10)
